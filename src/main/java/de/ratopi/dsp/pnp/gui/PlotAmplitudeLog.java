...
/**
 * PlotAmplitudeLog.java
 *
 *
 * Created: Sun Sep 16 13:51:16 2001
 *
 * @author
 * @version
 */
...
public class PlotAmplitudeLog
	extends PlotPane
{
	public PlotAmplitudeLog( Filter f )
	{
		super( f );
	}
	...
	{
		return "Betragsgang (dB)";
	}

	protected double[] getValues( Filter filter, int width )
	{
		return filter.amplitudeLog( width );
	}
