...
/**
 * PlotImpulseresponse.java
 *
 *
 * Created: Sun Sep 16 13:59:51 2001
 *
 * @author
 * @version
 */
...
public class PlotImpulseresponse
	extends PlotPane
{
	public PlotImpulseresponse( Filter f )
	{
		super( f );
	}
	...
	{
		return "Impulsantwort";
	}

	protected double[] getValues( Filter filter, int width )
	{
		return filter.impulseresponse( width );
	}
